...
if(NOT EXISTS "/content/colmap/build/colmap/build/_deps/poselib-build/install_manifest.txt")
  message(FATAL_ERROR "Cannot find install manifest: /content/colmap/build/colmap/build/_deps/poselib-build/install_manifest.txt")
endif()

# remove files from 'install_manifest.txt'
message(STATUS "")
message(STATUS "Removing files from 'install_manifest.txt'")
file(READ "/content/colmap/build/colmap/build/_deps/poselib-build/install_manifest.txt" files)
string(REGEX REPLACE "\n" ";" files "${files}")
foreach(file ${files})
  message(STATUS "Uninstalling $ENV{DESTDIR}${file}")
  if(IS_SYMLINK "$ENV{DESTDIR}${file}" OR EXISTS "$ENV{DESTDIR}${file}")
    exec_program("/usr/local/lib/python3.10/dist-packages/cmake/data/bin/cmake" ARGS "-E remove \"$ENV{DESTDIR}${file}\""
