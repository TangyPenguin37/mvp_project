...
set_target_properties(colmap::colmap_estimators PROPERTIES
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:colmap::PoseLib>;colmap::colmap_util;colmap::colmap_math;colmap::colmap_feature_types;colmap::colmap_geometry;colmap::colmap_sensor;colmap::colmap_image;colmap::colmap_scene;colmap::colmap_optim;Eigen3::Eigen;Ceres::ceres;colmap::colmap_util_cuda"
)
...
set_target_properties(colmap::colmap_util PROPERTIES
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:Boost::boost>;\$<LINK_ONLY:\$<\$<AND:\$<CXX_COMPILER_ID:GNU>,\$<VERSION_LESS:\$<CXX_COMPILER_VERSION>,9.0>>:-lstdc++fs>>;Eigen3::Eigen;glog::glog;SQLite::SQLite3;Qt5::Core;Qt5::OpenGL;OpenGL::GL"
)
...
# Create imported target colmap::PoseLib
add_library(colmap::PoseLib STATIC IMPORTED)

set_target_properties(colmap::PoseLib PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "POSELIB_DEBUG=\$<CONFIG:Debug>"
